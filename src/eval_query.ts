...
//          JOIN dance_order o ON o.dance_id = d.follows_dance_id
// )
// SELECT ROW_NUMBER() OVER (ORDER BY start_id, level) AS rownum, recital_group, recital_id, dance_id, follows_dance_id, start_id, level
// FROM dance_order
